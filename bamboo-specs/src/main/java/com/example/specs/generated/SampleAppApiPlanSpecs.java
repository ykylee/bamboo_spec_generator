...
public final class SampleAppApiPlanSpecs {
    private static final String PROJECT_KEY = "Y2026";
    private static final String PLAN_KEY = "SAMPAPI";
    private static final String YEAR = "2026";
    private static final String SCRIPT_ROOT = "scripts/generated/sample-app-api";

    private SampleAppApiPlanSpecs() {
    }
    ...
    public static Plan plan() {
        ...
        return new Plan(project, "Sample App API build plan", PLAN_KEY)
    ...
    .requirements(Requirement.equals("operating.system", "Linux"))
    .requirements(Requirement.exists("system.builder.mvn3.Maven 3"))
    .requirements(Requirement.exists("system.cuda.12.1"))
